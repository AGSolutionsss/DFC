...
export default class NewListDriver extends React.Component {
  state = {
    loader: true,
    users: [],
    driverData: [],
  ...
  getData = () => {
    let result = [];
    axios({
      url: baseURL+"/web-fetch-driver-list",
      method: "GET",
      headers: {
      ...
      .then((res) => {
        ...
        for (let i = 0; i < response.length; i++) {
            ...
            tempRows.push([
              ...
              response[i]["user_branch"],
              response[i]["user_company"],
              response[i]["mobile"],
        ...
        this.setState({ driverData: tempRows, loader: false });
      })
      .catch((res) => {
