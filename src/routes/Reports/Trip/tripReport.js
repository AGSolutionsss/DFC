  ...
  return (
    <div>
      ...
      <div className="invoice-wrapper">
        <PageTitleBar title="Trips Summary" match={props.match} />
        <div className="row">
                ...
                <div className="d-flex justify-content-between" style={{fontSize: '16px' }}>
                  ...
                  <div className="address text-center">
                    ...
                    <h2 style={{paddingTop: '5px'}}>
                      <strong>
                        <b style={{fontSize: '20px'}}>TRIPS SUMMARY</b>
                      </strong>
                    </h2>
                  </div>
                    ...
                    <Table aria-label="simple table" style={{border: '2px solid black', marginTop: '20px'}}>
                      <TableHead>          
                        <TableRow>
                          ...
                          <TableCell style={table_head}>Destination/Agency</TableCell>
                          ...
                          <TableCell style={table_head}>Cost Centre</TableCell>
                      ...
                      <TableBody>
                        {tripsummary.map((dataSumm, key)=>(
                          <TableRow key={dataSumm.trip_date}>
                            ...
                            <TableCell style={table_row_count}><NumberFormat 
                       ...
                       <TableFooter>
                        <TableRow>
                          <TableCell colSpan={5} style={table_row_count}>
                          ...
                          <TableCell style={table_row_count}>
                            <span style={footertable}>{tripsummaryfooter.trip_hsd}</span>
                          </TableCell>
                          <TableCell style={table_row_count}>
...
export default TripSummaryReport;
