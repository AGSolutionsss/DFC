...
const TeamSummaryForm = (props) => {
    let history = useHistory();
    const [downloadTeam, setTeamDownload] = useState({
        user_company:"",
        user_branch: "", 
  });
  ...
  const onSubmit = (e) => {
   e.preventDefault();
    let data = {
        ...
        user_branch: downloadTeam.user_branch,
    };
...
if(v){
 setIsButtonDisabled(true)
   axios({
    ...
    link.click();
     NotificationManager.success("Team is Downloaded Successfully");
       setIsButtonDisabled(false)
   }).catch((err) =>{
    NotificationManager.error("Team is Not Downloaded");
    setIsButtonDisabled(false)
  });
 }
 };
 ...
 const onReportView = (e) => {
  ...
  localStorage.setItem('user_branch',downloadTeam.user_branch);
  history.push("teamReport");
  ...
  return (
    <div className="textfields-wrapper">
      <PageTitleBar title="Team" match={props.match} />
      <RctCollapsibleCard>
...
export default TeamSummaryForm;
