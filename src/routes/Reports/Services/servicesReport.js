...
const ServicesSummaryReport = (props) => {
  ...
  useEffect(() => {
    ...
    axios({
      url: baseURL+"/fetch-services-report",
      method: "POST",
      data,
      headers: {
  ...
  return (
    <div>
      ...
      <div className="invoice-wrapper">
        <PageTitleBar title="Services Summary" match={props.match} />
        <div className="row">
                ...
                <div className="d-flex justify-content-between" style={{fontSize: '16px' }}>
                  ...
                  <div className="address text-center">
                    ...
                    <h2 style={{paddingTop: '5px'}}>
                      <strong>
                        <b style={{fontSize: '20px'}}>SERVICES SUMMARY</b>
                      </strong>
                    </h2>
                  </div>
                    ...
                    <Table aria-label="simple table" style={{border: '2px solid black', marginTop: '20px'}}>
                      <TableHead>          
                        <TableRow>
                          ...
                          <TableCell style={table_head}>Garage</TableCell>
                          <TableCell style={table_head}>Amount</TableCell>
                          <TableCell style={table_head}>No of Changes</TableCell>
                         </TableRow>
                      </TableHead>
                      <TableBody>
                        {servicesummary.map((dataSumm, key)=>(
                          <TableRow key={dataSumm.service_date}>
                            ...
                            <TableCell style={table_row_count}>{dataSumm.service_company}</TableCell>
                            <TableCell style={table_row_count}>{dataSumm.service_branch}</TableCell>
                            <TableCell style={table_row_count}>{dataSumm.service_garage}</TableCell>
                            <TableCell style={table_row_count}>
                              <NumberFormat 
                                ...
                                displayType={'text'}
                                prefix={'₹ '} 
                                value={dataSumm.service_amount}
                              />
                            </TableCell>
                            <TableCell style={table_row_count}>{dataSumm.service_count}</TableCell>
                          </TableRow>
                        ))}
                       </TableBody>
                    </Table>
